...
function T:call(t,args)
  ...
  local ok,e=u:sendto(s,host,port); if not ok then u:close(); return nil,e end; local out,er=u:receive(); u:close(); if not out then return nil,er end; return json.decode(out) or out
end
